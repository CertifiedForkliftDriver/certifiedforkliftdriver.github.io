...
function displayGameList(games){
    ...
    //     <a onclick="window.location.href = 'html/about.html'"><div class = "search-item-thumbnail">
    //         <img src = "${gamePoster}">
    //     </div>
...
//     const gameDetails = document.implementation.createHTMLDocument('Game Details');
//     // Create the HTML structure for the game details
//     gameDetails.body.innerHTML = `
...
//     </div>
// `;
    // Open the new HTML file in a new browser window
    // let gameDetailsWindow = window.open('', '_blank');
    // gameDetailsWindow.document.write(gameDetails.documentElement.outerHTML);
    // gameDetailsWindow.document.close();
