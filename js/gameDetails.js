...
const apiKey = '165cef52ff124c82ae9fe6b59d64a946';
...
async function getGameDevelopers(gameId) {
    const response = await fetch(`https://api.rawg.io/api/games/${gameId}/development-team?key=165cef52ff124c82ae9fe6b59d64a946`);
