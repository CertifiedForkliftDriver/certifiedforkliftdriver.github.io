...
async def requests():
    async with rawg.ApiClient(rawg.Configuration(api_key={'key': '165cef52ff124c82ae9fe6b59d64a946'})) as api_client:
        # Create an instance of the API class
        api = rawg.GamesApi(api_client)

        # Making requests
        coros = [api.games_read(id=name) for name in ['grand-theft-auto-v', 'minecraft', 'elden-ring']]
